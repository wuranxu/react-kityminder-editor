...
import {buttons, initData} from './constants';
import {NavBar} from './components';
import {clipboardRuntime, editInput, preview} from './util';
import {DoubleLeftOutlined, LockOutlined, UnlockOutlined} from '@ant-design/icons';
...
class KityminderEditor extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            inputContent: null,
            activeTab: '1',
            showToolBar: this.props.type !== 'compare',
            fullScreen: false,
            loading: false,
            ...
            <ConfigProvider locale={zhCN}>
                ...
                >
                    ...
                    {minder && (
                        <Tabs
                            ...
                            tabBarExtraContent={[
                                ...
                                >
                                    <DoubleLeftOutlined rotate={showToolBar ? 90 : -90}/>{' '}
                                    {showToolBar ? '收起' : '展开'}
                                </Button>,
                            ]}
                            onChange={activeKey => {
                    ...
                    <div
                        ...
                        style={{
                            height: `calc(100vh - 62px - ${showToolBar ? '80px' : '0px'})`,
                        }}
                    >
