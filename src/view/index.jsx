...
import {ArrowsAltOutlined, CaretDownOutlined, DownOutlined, UpOutlined} from "@ant-design/icons";
...
const ViewGroup = props => {
  ...
  const expandMenu = (
    <Menu onClick={handleExpandClick} items={generateMenu(expandToList)}/>
  );
  const selectedMenu = (
    <Menu onClick={handleSelectClick} items={generateMenu(selectedList)}/>
  );
  return (
    <div className="nodes-actions" style={{ width: '100%' }}>
      ...
      >
        <Button type="link" size="small" className="big-icon">
          <ArrowsAltOutlined  style={{ fontSize: '1.6em' }}/>
          <br />
